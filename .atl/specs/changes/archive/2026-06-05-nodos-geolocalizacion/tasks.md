...
- [x] Create Jest unit tests for `CreateNodeDto` and `UpdateNodeDto` coordinate range validations.
- [x] Write Jasmine unit/component tests in `frontend/src/app/pages/admin/nodos/nodos.page.spec.ts` verifying manual coordinates inputs, search debounce, and component destruction.
- [x] Perform manual end-to-end testing of map loading, geocoding flow, and database persistence.
